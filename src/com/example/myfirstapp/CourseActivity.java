...
import com.example.myfirstapp.PoiDetailActivity;
import com.example.myfirstapp.PoiBean;
...
public class CourseActivity extends Activity implements LocationListener, ArchitectUrlListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button = getIntent().getStringExtra(MainActivity.EXTRA_MESSAGE);
